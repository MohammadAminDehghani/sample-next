import InnerCreateProductForm from "@/app/tools/components/admin/products/innerCreateProductForm";
import { CreateProductInterface } from "@/app/tools/contracts/admin/products";
import validationErrors from "@/app/tools/exceptions/validationErrors";
import { withFormik } from "formik";
import * as yup from 'yup';
import { toast } from 'react-toastify';
import { CreateProduct, GetProducts } from "@/app/tools/services/db/product";
