import { EditProductInterface } from "@/app/tools/contracts/admin/products";
import validationErrors from "@/app/tools/exceptions/validationErrors";
import { UpdateProduct } from "@/app/tools/services/db/product";
import { withFormik } from "formik";
import Router from "next/router";
import * as yup from 'yup';
import { toast } from 'react-toastify';
import Product from "@/app/tools/models/product";
import InnerEditProductForm from "@/app/tools/components/admin/products/innerEditProductForm";
