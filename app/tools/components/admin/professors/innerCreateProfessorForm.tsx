...
const InnerCreateProfessorForm = (props: FormikProps<StoreProfessorInterface>) => {

  return (
    
    <Form>
      <div className="px-6 text-lg">Create Professor</div>
...
export default InnerCreateProfessorForm;
