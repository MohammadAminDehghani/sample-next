...
const InnerEditProfessorForm = (props: FormikProps<any>) => {
  //console.log('propsInInnerProfessorForm', props)
  return (
    <Form>
      ...
      <div className="p-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center">
        ...
        <button
          type="button"
          onClick={()=>{ props.values.setShowCreateProfessor(true) } }
...
export default InnerEditProfessorForm;
